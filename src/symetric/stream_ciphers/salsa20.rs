...
const SIG0: u32 = 0x61707865;
const SIG1: u32 = 0x3320646E;
const SIG2: u32 = 0x79622D32;
const SIG3: u32 = 0x6B206574;


pub struct Salsa20K32 {
...
impl StreamCipher for Salsa20K32 {
    ...
    fn new(init_struct: &Self::InitStruct, key: &[u8; Self::KEY_SIZE]) -> Self{
        ...
        let k : [u32; 8] = (0..Self::KEY_SIZE)
            .step_by(4)
            .map(|i| u32::from_le_bytes(key[i..i+4].try_into().unwrap()))
            .collect::<Vec<u32>>()
            .try_into().unwrap();
        ...
        Salsa20K32{state, remaining_bytes: 0 }
    }

    fn from_state(state: &Self::State) -> Self {
        Salsa20K32{state: *state, remaining_bytes: 0}
    }
...
mod tests_chacha {
    ...
    #[test]
    fn test_cipher_3_times_1_block() {
        let nonce = 0x0011223344556677;
        let key = [
            0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
            0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
    ...
    #[test]
    fn test_cipher_2_blocks_fragmented() {
        let nonce = 0x0011223344556677;
        let key = [
            0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
            0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
