...
mod tests_cbc {
    ...
    fn cbc_encrypt_2_blocks() {
        ...
        CBC::cipher(&AES128{}, &plain, &mut ciphertext, &key, &iv).expect("Error during CBC_AES128 execution");
    ...
    fn cbc_encrypt_bad_length() {
        ...
        let res = CBC::cipher(&AES128{}, &plain, &mut ciphertext, &key, &iv);
        assert!(res.is_err());
    }
    ...
    fn cbc_decrypt_2_blocks() {
        ...
        let expected = [0x6B, 0xC1, 0xBE, 0xE2, 0x2E, 0x40, 0x9F, 0x96, 0xE9, 0x3D, 0x7E, 0x11, 0x73, 0x93, 0x17, 0x2A,
            0xAE, 0x2D, 0x8A, 0x57, 0x1E, 0x03, 0xAC, 0x9C, 0x9E, 0xB7, 0x6F, 0xAC, 0x45, 0xAF, 0x8E, 0x51];
        CBC::decipher(&AES128{}, &mut plain, &ciphertext, &key, &iv).expect("Error during CBC_AES128 execution");
    ...
    fn cbc_decrypt_bad_length() {
        ...
        let res = CBC::decipher(&AES128{}, &mut plain, &ciphertext, &key, &iv);
        assert!(res.is_err());
    }
